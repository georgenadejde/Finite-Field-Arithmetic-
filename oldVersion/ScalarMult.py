...
def j_invariant(a, modP):
	'''
	Computes the j-invariant of a Montgomery curve
	
	Params:
	a: Montgomery coefficient
	modP: modulo of the finite field

	Return:
	j(E_a)
	'''

	return modP(modP(256 * ((a*a -3)**3)) // modP(a*a - 4))
...
def main():
	...
	- added a simplify_point method and 
	  a new optional parameter in the constructor, but not sure if needed,
